...
(() => {
  ...
  class ThreeDStage extends HTMLElement {
    constructor() {
      ...
      note.className = 'note';
      note.textContent = this.getAttribute('hint') || 'Drag to orbit · scroll to zoom · right-drag to pan';
      if (this.hasAttribute('bare') || note.textContent === 'off') note.style.display = 'none';
